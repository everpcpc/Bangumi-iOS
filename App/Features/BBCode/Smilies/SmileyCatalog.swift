...
public struct BBCodeSmileyItem: Identifiable, Hashable, Sendable {
...
public struct BBCodeSmileyGroup: Identifiable, Hashable, Sendable {
  public let key: String
  public let title: String
  public let items: [BBCodeSmileyItem]

  public var id: String { key }
}

public struct BBCodeSmileySection: Identifiable, Hashable, Sendable {
  public let key: String
  public let title: String
  public let iconCode: String
  public let groups: [BBCodeSmileyGroup]

  public var id: String { key }
  public var items: [BBCodeSmileyItem] { groups.flatMap(\.items) }
}

public enum BBCodeSmileyCatalog {
  public static let sections: [BBCodeSmileySection] = makeSections()
  public static let allItems: [BBCodeSmileyItem] = sections.flatMap(\.items)

  private static let itemLookup: [String: BBCodeSmileyItem] = Dictionary(
    uniqueKeysWithValues: allItems.map { ($0.code, $0) }
  )

  public static func item(for code: String) -> BBCodeSmileyItem? {
...
extension BBCodeSmileyCatalog {
  fileprivate static let resourceRoot = "Smilies"

  fileprivate static func makeSections() -> [BBCodeSmileySection] {
    [
  ...
  fileprivate static func makeBangumiClassicSection() -> BBCodeSmileySection {
  ...
  fileprivate static func makeBangumiTVSection() -> BBCodeSmileySection {
  ...
  fileprivate static func makeBangumiVSSection() -> BBCodeSmileySection {
  ...
  fileprivate static func makeBangumi500Section() -> BBCodeSmileySection {
  ...
  fileprivate static func makeMusumeSection() -> BBCodeSmileySection {
  ...
  fileprivate static func makeBlakeSection() -> BBCodeSmileySection {
