...
// BMO Emoji Renderer
struct BBCodeBmoRenderer {

  // Render BMO emoji as SwiftUI Image
  @MainActor
  static func renderImage(
    from result: BBCodeBmoDecoder.BmoResult, size: CGSize? = nil, textSize: Int = 16
  ) -> Image? {
  ...
  private static func drawItem(
    _ item: BBCodeBmoDecoder.BmoDecodedItem, in context: CGContext, size: CGSize
  ) {
  ...
  private static func loadBmoImage(filename: String) -> CGImage? {
    ...
    url = BangumiStickerResources.url(
